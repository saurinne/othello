...
def test_beginning1():
    ...
    assert othello.create_beginning_disks(8,8) == disks

def test_beginning2():
    disks = {(4,4): "x", (5,5): "x", (5,4): "o", (4,5): "o"}
    assert othello.create_beginning_disks(10,10) == disks

def test_check_move1():
    disks = {(3,3): "x", (4,4): "x", (3,4): "o", (4,3): "o"}
    assert othello.check_possible_move(disks, "x", 8, 8)

def test_check_coordinates1():
    disks ={(0,0): "o", (0,1): "x", (0,2): "x", (0,3): "x", (1,0): "x", (2,0): "x", (3,0): "x"}
    new = (0,0)
    with pytest.raises(ValueError):
        othello.check_coordinates(disks, new, 8,8)
...
def test_check_coordinates2():
    ...
    new = (10,10)
    with pytest.raises(ValueError):
        othello.check_coordinates(disks, new, -1,8)

def test_check_move2():
    disks = {(1,1): "x", (2,1): "x", (3,1): "x", (1,2): "x", (1,3): "x", (2,3): "x", (3,3): "x", (3,2): "x", (2,2): "o"}
    assert othello.check_possible_move(disks, "x", 8, 8) == False

def test_check_move3():
    disks = {(1,1): "x", (2,1): "x", (3,1): "x", (1,2): "x", (1,3): "x", (2,3): "x", (3,3): "x", (3,2): "x", (2,2): "o"}
    assert othello.check_possible_move(disks, "o", 8, 8) == True

def test_check_move4():
    disks ={(0,0): "o", (0,1): "x", (0,2): "x", (0,3): "x", (1,0): "x", (2,0): "x", (3,0): "x"}
    assert othello.check_possible_move(disks, "o", 4,4) == False

def test_check_move5():
    disks ={(0,0): "o", (0,1): "x", (0,2): "x", (0,3): "x", (1,0): "x", (2,0): "x", (3,0): "x"}
    assert othello.check_possible_move(disks, "x", 4,4) == False

def test_all_moves(): 
    disks ={(0,0): "o", (0,1): "x", (0,2): "x", (0,3): "x", (1,0): "x", (2,0): "x", (3,0): "x"}
    assert othello.check_all_moves(disks, 4, 4)

def test_all_moves2(): 
    disks ={(0,0): "o", (0,1): "x", (0,2): "x", (0,3): "x", (1,0): "x", (2,0): "x", (3,0): "x"}
    assert othello.check_all_moves(disks, 5, 5) == False

def test_end1():
    disks ={(0,0): "x", (0,1): "x", (0,2): "x", (0,3): "x", (1,0): "x", (2,0): "x", (3,0): "x"}
    assert othello.end(disks, 8, 8)
